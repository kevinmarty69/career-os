...
export const homeMessages = {
  ...
  'Tout voir': 'View all',
  'Aucun lien actif.': 'No active link.',
  'Priorités explicables': 'Explainable priorities',
  'La prochaine action vient uniquement de l’état enregistré de vos candidatures et de vos décisions humaines.':
    'The next action comes only from the recorded state of your applications and human decisions.',
