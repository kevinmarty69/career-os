...
comment on table app.worker_heartbeats is
  'Global liveness only. Contains no tenant, job, host, or credential data.';
...
revoke all on app.worker_heartbeats from public, career_app,
  career_company_researcher, career_evidence_archivist,
  career_recruiter_strategist, career_page_composer,
  career_recruiter_reviewer, career_hiring_manager_reviewer,
  career_factuality_reviewer, career_worker, career_reviewer,
  career_publisher, career_reader;
...
to career_company_researcher, career_evidence_archivist,
  career_recruiter_strategist, career_page_composer,
  career_recruiter_reviewer, career_hiring_manager_reviewer,
  career_factuality_reviewer;

grant execute on function app.worker_service_status(text) to career_app;
