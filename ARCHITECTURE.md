...
`memory + application revision → immutable snapshots → durable research step → evidence selection → PageSpec → three reviews → human approval → private capability`
